...
for iterNum = 1:param.numIteration
	...
	% AKJ - CoefMatrix = NN_BP(Data, [FixedDictionaryElement,Dictionary],param.L,CoefMatrix);
    for ii = 1:size(Data,2)
      CoefMatrix(:,ii) = fnnomp([FixedDictionaryElement,Dictionary],Data(:,ii),param.L,param.errorGoal);
    end
